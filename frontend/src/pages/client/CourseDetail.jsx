        ...
        <div className="max-w-7xl mx-auto py-8 px-4 md:px-8 flex flex-col gap-2">
          ...
          {course.averageRating && (
            <p className="text-sm flex items-center gap-1">
              ...
              {course.averageRating.toFixed(1)} ({course.numberOfRatings}{" "}
              ratings)
            </p>
          )}
                ...
                <>
                  ...
                  {!course.isRatedByUser && (
                    <div className="w-full text-center">
                      ...
                      <StarRating
                        courseId={courseId}
                        isRatedByUser={course.isRatedByUser}
                        initialRating={course.userRatingValue}
                      />
                    </div>
                  )}
                </>
